...
function($ionicTemplateLoader, $ionicBackdrop, $q, $timeout, $rootScope, $ionicBody, $compile, $ionicPlatform, IONIC_BACK_PRIORITY) {
  ...
  var $ionicPopup = {
     ...
     * and resolve the popup promise with its return value.  If you Order to prevent the
 ...
 * and one or more `<ion-side-menu>` directives for each side menu(left/right) that you Order to place.
 *
 * ```html
 * <ion-side-menus>
 *   <!-- Center content -->
